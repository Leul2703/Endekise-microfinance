...
import { Lock, User, Sparkles, ArrowRight, AlertCircle, Home, UserPlus, Eye, EyeOff } from 'lucide-react';
    ...
    <div className="login-container">
      ...
      <div className="login-card">
        ...
        <div className="login-header">
          ...
          <p>Secure sign-in for loan staff, branch managers, leadership, and clients.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="login-form">
          ...
          <div className="form-group">
            ...
            <small className="field-hint">Use your assigned username and secure password to continue.</small>
          </div>
